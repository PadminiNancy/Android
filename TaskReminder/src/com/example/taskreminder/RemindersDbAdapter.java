...
public class RemindersDbAdapter {
	...
	private static final String DATABASE_NAME = "what"; 
	private static final String DATABASE_TABLE = "taskreminders"; 
	...
	private static final String DATABASE_CREATE = 
			...
			public long createReminder(String title, String body, String
					...
					long ss =  mDb.insert(DATABASE_TABLE, null, initialValues); 
					mDb.close();
					return ss;
