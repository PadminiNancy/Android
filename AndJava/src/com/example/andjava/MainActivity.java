    ...
    public  void register(){
    	 ...
    	 try{           
	           ...
	           // response=httpclient.execute(httppost);
	            ...
	            rr = httpclient.execute(httppost, responseHandler);
	          ...
	          // rr = respon;
	            ...
	            runOnUiThread(new Runnable() {
	                public void run() {
	                	...
	                	resu.setText(rr);
	                	String tr = resu.getText().toString();
	                	if(rr.trim().equals("r")){
	                	  //Toast.makeText(getApplicationContext(), rr+"k", Toast.LENGTH_SHORT).show();
	                		Intent i = new Intent(getApplicationContext(),SecActivity.class);
	                        startActivity(i);
	                	}
	                	else{
	    	            	Toast.makeText(MainActivity.this,"Registration UnSuccess", Toast.LENGTH_SHORT).show();               
	    	            }
	                    dialog.dismiss();
	                }
	            });
